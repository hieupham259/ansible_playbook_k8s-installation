...
Các Pod trong Kubernetes có [vòng đời được định nghĩa rõ ràng](47-pod-lifecycle-vi.md).
...
* [Deployment](63-deployment-vi.md) và [ReplicaSet](64-replicaset-vi.md)
...
* [StatefulSet](65-statefulset-vi.md) cho phép bạn
  ...
  [PersistentVolume](92-persistent-volumes-vi.md). Mã của bạn, chạy trong các
...
* [DaemonSet](66-daemonset-vi.md) định nghĩa các Pod cung cấp
  ...
  chẳng hạn một plugin để chạy [mạng của cluster (cluster networking)](157-networking-vi.md#how-to-implement-the-kubernetes-network-model),
...
* [Job](67-job-vi.md) và
  [CronJob](69-cron-jobs-vi.md) cung cấp những cách khác nhau để
  định nghĩa các tác vụ chạy đến khi hoàn tất rồi dừng lại.
  Bạn có thể dùng [Job](67-job-vi.md) để
  định nghĩa một tác vụ chạy đến khi hoàn tất, chỉ một lần. Bạn có thể dùng
  [CronJob](69-cron-jobs-vi.md) để chạy
...
[custom resource definition](179-custom-resources-vi.md),
...
[Workload API](77-workload-api-vi.md) cho phép bạn định nghĩa các `PodGroupTemplates` để nhóm các Pod lại và áp dụng các chính sách lập lịch nâng cao cho chúng,
chẳng hạn [gang scheduling](150-gang-scheduling-vi.md).
Các controller tạo ra các đối tượng [PodGroup](75-podgroup-api-vi.md) từ các template này lúc chạy (runtime),
...
* [Chạy một ứng dụng phi trạng thái bằng Deployment](345-run-stateless-application-vi.md)
* Chạy một ứng dụng có trạng thái, dưới dạng [một thực thể đơn lẻ](344-run-single-instance-stateful-vi.md)
  hoặc dưới dạng [một tập được nhân bản](343-run-replicated-stateful-application-vi.md)
...
hãy xem [Configuration](107-configuration-vi.md).
...
* [Controller _time-to-live after finished_](68-ttlafterfinished-vi.md)
...
một [Service](82-service-vi.md) hoặc, chỉ với ứng dụng web,
