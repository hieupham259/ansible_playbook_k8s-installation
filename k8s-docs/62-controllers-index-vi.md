...
[Deployment](63-deployment-vi.md) (và gián tiếp là [ReplicaSet](64-replicaset-vi.md)),
...
[mạng của cluster (cluster networking)](157-networking-vi.md#how-to-implement-the-kubernetes-network-model),
...
Bạn có thể dùng [Job](67-job-vi.md) và / hoặc
[CronJob](69-cron-jobs-vi.md) để
...
- [Tự động dọn dẹp các Job đã hoàn tất (Automatic Cleanup for Finished Jobs)](68-ttlafterfinished-vi.md)
