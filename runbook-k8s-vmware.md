...
- bảng nhìn nhanh "mỗi mục của §14 cài gì, phục vụ gì" và từ điển khái niệm nền cho người chưa quen: certificate/CA và "ký" là gì, "cert do CA riêng của Rancher ký" nghĩa là gì, cụm `local` vs downstream cluster (kèm bảng so sánh các loại cluster), `cattle-cluster-agent` là gì, split DNS là gì;
