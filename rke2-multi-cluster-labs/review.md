...
### 2. (từ M1-08, thu hẹp) Bốn thành phần chốt version ở pilot

MinIO server/`mc`, `gitlab-runner` chart, Reflector: pin bằng đúng version pilot chạy PASS.
Helm đã chuyển sang 4.x theo yêu cầu của GitLab chart, nhưng version 4 cụ thể cũng ghi nhận
tại pilot.

### 3. (từ M1-10 + M2-16) Logging tập trung vẫn nằm ngoài phạm vi bắt buộc
...
### 4. (từ M2-09, thu hẹp) Negative test của §8 còn ở dạng mô tả
...
### 5. (từ M2-13, thu hẹp) Hai restore còn ở mức thao tác hướng dẫn
...
### 6. (từ M2-16) Ngưỡng capacity mới là ngưỡng tham chiếu
...
3. Cập nhật hai file LAB theo mọi điểm lệch; pin nốt các thành phần ở mục 2.
